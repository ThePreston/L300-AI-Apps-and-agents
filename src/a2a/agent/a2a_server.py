...
class A2AServer:
    ...
    def _setup_server(self):
        ...
        app_name = "Zava Product Helper"
        
        # Create A2A Starlette application config wrapper
        self.a2a_app_wrapper = A2AStarletteApplication(
            agent_card=self._get_agent_card(),
            http_handler=request_handler
        )
        
        # Build the actual Starlette app with title
        self.starlette_app = self.a2a_app_wrapper.build()
    ...
    def _get_agent_card(self) -> AgentCard:
        ...
        agent_card = AgentCard(
            ...
            url=f'http://{self.host}:{self.port}/a2a', # URL is usually determined at runtime or deployment
            version='1.0.0',
